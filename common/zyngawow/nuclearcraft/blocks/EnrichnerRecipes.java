...
public class EnrichnerRecipes {
	...
	//this.addEnrichment(Item.coal.shiftedIndex, new ItemStack(Block.blockSteel), 0.7F, 10, 1F);
	this.addEnrichment(Item.ingotIron.shiftedIndex, new ItemStack(Item.coal), 0.7F, 10, 1F);
    }

    public void addEnrichment(int par1, ItemStack par2ItemStack, float par3, float par4, float par5){
	this.enrichmentList.put(Integer.valueOf(par1), par2ItemStack);
	this.experienceList.put(Integer.valueOf(par2ItemStack.itemID), Float.valueOf(par3));
	this.costList.put(Integer.valueOf(par2ItemStack.itemID), Float.valueOf(par4));
	this.chanceList.put(Integer.valueOf(par2ItemStack.itemID), Float.valueOf(par5));
    }
    ...
    public float getChance(int par1){
	return this.chanceList.containsKey(Integer.valueOf(par1)) ? ((Float)this.chanceList.get(Integer.valueOf(par1))).floatValue() : 0.0F;
    }
    public float getCost(int par1){
	return this.costList.containsKey(Integer.valueOf(par1)) ? ((Float)this.costList.get(Integer.valueOf(par1))).floatValue() : 0.0F;
    }
