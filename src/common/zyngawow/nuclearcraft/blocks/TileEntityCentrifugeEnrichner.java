...
public class TileEntityCentrifugeEnrichner extends TileEntity implements IInventory{
	...
	private void enrichItem(){
		if(this.canEnrich()){
			{
				System.out.println(this.batteryStack[1]);
				ItemStack var1 = EnrichnerRecipes.enrichment().getEnrichmentResult(this.batteryStack[1]);
				...
				--this.batteryStack[1].stackSize;

				if (this.batteryStack[1].stackSize <= 0)
				{
					this.batteryStack[1] = null;
				}
